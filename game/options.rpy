...
define config.name = _("Ainu Stories")
...
define config.main_menu_music = "audio/shunshoku_runway_inst_aoba.ogg"
...
define config.save_directory = "AobaGames_OniiChan"
