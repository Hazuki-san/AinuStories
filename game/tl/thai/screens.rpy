# TODO: Translation updated at 2021-04-23 08:50
...
translate thai strings:
    ...
    new "เลื่อนบทสนทนาและใช้งานอินเทอร์เฟซ"
    ...
    new "เลื่อนบทสนทนาโดยไม่เลือกตัวเลือก"
    ...
    new "ข้ามบทสนทนาขณะที่กดค้างไว้"
    ...
    new "เลื่อนกลับไปยังบทสนาก่อนหน้านี้"
    ...
    new "เปิดตัวช่วย{a=https://www.renpy.org/l/voicing}พากย์อัตโนมัติ{/a}"
